    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">
                Update and refine your coding challenge
            </p>
        </div>
        ...
        use:enhance={() => {
            ...
            return async ({ update, result }) => {
                ...
                if (result.type === "failure") {
                    message =
                        (result.data?.error as string) || "Update failed.";
                }
            };
        }}
        class="space-y-6"
    >
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full border border-gray-300 px-4 py-2.5 rounded-md h-24 resize-none"
                    ></textarea>
                </div>
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200">
            ...
            <div class="p-6">
                ...
                <textarea
                    ...
                    class="w-full border border-gray-300 px-4 py-2.5 rounded-md h-48 font-mono text-sm bg-gray-50 resize-none"
                ></textarea>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200">
            ...
            <div class="p-6 space-y-4">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            ...
                            >
                                <div>
                                    <label
                                        for="test_input_{i}"
                                        class="text-xs block mb-1">Input</label
                                    >
                                    <input
                                        id="test_input_{i}"
                ...
                <!-- NEW -->
                <div
                    class="border-2 border-dashed border-gray-300 rounded-lg p-5"
                >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        ...
                        <div>
                            <label
                                for="new_test_expected"
                                class="text-xs block mb-1">Expected</label
                            >
                            <input
                                id="new_test_expected"
                    ...
                    <label class="flex items-center gap-2 mb-3 cursor-pointer">
                        <input
                            type="checkbox"
                            bind:checked={newTest.is_hidden}
                            class="rounded border-gray-300"
                        />
                        <span class="text-sm">Hidden</span>
                    </label>
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="space-y-3">
                    {#each criteria as c, i (i)}
                        <div class="border border-gray-200 rounded-lg p-4">
                            ...
                            <div
                                class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3"
                            >
                                <div class="md:col-span-2">
                                    <label
                                        for="criterion_aspect_{i}"
                                        class="text-xs block mb-1">Aspect</label
                                    >
                                    <input
                                        id="criterion_aspect_{i}"
                                ...
                                <div>
                                    <label
                                        for="criterion_weight_{i}"
                                        class="text-xs block mb-1">Weight</label
                                    >
                                    <input
                                        id="criterion_weight_{i}"
                                        type="number"
                                        step="0.1"
                                        min="0.1"
                                        max="1.0"
                            ...
                            <div>
                                <label
                                    for="criterion_desc_{i}"
                                    class="text-xs block mb-1"
                                    >Description</label
                                >
                                <textarea
                                    id="criterion_desc_{i}"
                                    name={`criteria[${i}][description]`}
                                    bind:value={c.description}
                                    class="border border-gray-300 px-3 py-2 rounded-md w-full h-20 resize-none"
                                ></textarea>
                            </div>
                        </div>
                    {/each}
                ...
                >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                        <div class="md:col-span-2">
                            <label
                                for="new_criterion_aspect"
                                class="text-xs block mb-1">Aspect</label
                            >
                            <input
                                id="new_criterion_aspect"
                        ...
                        <div>
                            <label
                                for="new_criterion_weight"
                                class="text-xs block mb-1">Weight</label
                            >
                            <input
                                id="new_criterion_weight"
                                type="number"
                                step="0.1"
                                min="0.1"
                                max="1.0"
                    ...
                    <div class="mb-3">
                        <label
                            for="new_criterion_desc"
                            class="text-xs block mb-1">Description</label
                        >
                        <textarea
                            id="new_criterion_desc"
                ...
                <div class="pt-4 border-t border-gray-200">
                    <label for="tone" class="block text-sm mb-2"
                        >Feedback Tone</label
                    >
                    <select
                        id="tone"
